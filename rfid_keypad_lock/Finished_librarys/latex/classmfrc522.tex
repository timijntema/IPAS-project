...
Address for the miscellaneous control bits register. 

Default constructor The constructor takes three items from the hwlib namespace, the already created spi interface, the ss or chip select line that is attached to the S\+DA pin of the \hyperlink{classmfrc522}{mfrc522} and the R\+E\+S\+ET pin. The R\+E\+S\+ET pin is for hard resetting the \hyperlink{classmfrc522}{mfrc522}. 
