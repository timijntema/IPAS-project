...
Default constructor This constructor takes a spi bus and a select pin as parameter. It sets the protected variables using these parameters. The protected variables can be used by the \hyperlink{class_r_f_i_d}{R\+F\+ID} class or any other class that inherits the \hyperlink{class_r_f_i_d}{R\+F\+ID} class. 
...
\item 
D\+:/programmeren/\+Projecten/\+I\+P\+A\+S-\/project/rfid\+\_\+keypad\+\_\+lock/\+Finished\+\_\+librarys/\hyperlink{_r_f_i_d_8hpp}{R\+F\+I\+D.\+hpp}\item 
D\+:/programmeren/\+Projecten/\+I\+P\+A\+S-\/project/rfid\+\_\+keypad\+\_\+lock/\+Finished\+\_\+librarys/\hyperlink{_r_f_i_d_8cpp}{R\+F\+I\+D.\+cpp}\end{DoxyCompactItemize}
